...
class UefaJSON:
    ...
    def write_clubs_uefa_cl():
        data = {'Реал Мадрид':
                    {'Страна': 'Испания', 'Трофеев': 15},
               'Милан':
                   {'Страна': 'Италия', 'Трофеев': 7},
               'Бавария':
                    {'Страна': 'Германия', 'Трофеев': 6},
               'Ливерпуль':
                    {'Страна': 'Англия', 'Трофеев': 6},
               'Барселона':
                    {'Страна': 'Испания', 'Трофеев': 5},
               'Аякс':
                    {'Страна': 'Голландия', 'Трофеев': 4},
               'Интернационале':
                    {'Страна': 'Италия', 'Трофеев': 3},
               'Манчестер Юнайтед':
                    {'Страна': 'Англия', 'Трофеев': 3}}
